...
<style type="text/css">
	html, body{
		background: url(..//backend/img/gg.jpg) no-repeat 0px 0px;
...
<script type="text/javascript" src="{{asset('/backend/js/jquery.dcjqaccordion.2.7.js')}}"></script>
...
<script type="text/javascript" src="{{asset('/backend/js/jquery.nicescroll.js')}}"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="js/flot-chart/excanvas.min.js"></script><![endif]-->
<script type="text/javascript" src="{{asset('/backend/js/jquery.scrollTo.js')}}"></script>
</body>
</html>
